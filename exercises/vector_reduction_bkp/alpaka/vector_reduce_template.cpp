...
struct ReduceKernel
{
        ...
        Idx const n) const -> void
    {
        ...
        // TODO: Calculate global thread index and grid stride
        // YOUR CODE HERE
        auto const globalIdx = /* TODO: blockIdx * TBlockSize + threadIdx */;
        auto const gridStride = /* TODO: gridDim * TBlockSize */;

        // TODO: Grid-stride reduction into shared memory
        // Each thread accumulates multiple elements if n > grid_size
        // YOUR CODE HERE
        T sum = 0;
        // YOUR LOOP HERE: for(Idx idx = globalIdx; idx < n; idx += gridStride)
